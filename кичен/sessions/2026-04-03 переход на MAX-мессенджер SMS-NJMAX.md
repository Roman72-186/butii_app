...
- **Двойной вызов webhook** в `bridge/api/bridge-webhook.js` (строки 118-148) — webhook вызывался дважды за один запрос, создавая дублирующие записи в External CRM. Исправлено через сохранение статуса в переменную `webhookStatus`.
